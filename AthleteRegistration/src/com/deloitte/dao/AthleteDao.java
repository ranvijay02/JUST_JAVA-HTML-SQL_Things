...
public class AthleteDao implements IAthleteDao {
	...
	public List<String> getCategory() throws AthleteException {
		...
		if(entityManager == null) {
			System.out.println("Entity maneger Null");
		}
		else {
		...
		/*
		 * List<String> aList = new ArrayList<>(); aList.add("Running");
		 * aList.add("High Jump"); aList.add("Hurdles"); aList.add("Relay");
		 * aList.add("Javelin Throw"); aList.add("Shot put"); return aList;
		 */
	}
